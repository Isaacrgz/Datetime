...
public class MainApp {
    public static void main(String[] args) {
        ...
        System.out.println("Get millis from String: " + getDatetimeFromStringToMillis("14/05/2024") + ", reverse: " + getMillisToDateTime(getDatetimeFromStringToMillis("14/05/2024")));
        System.out.println("Get millis from String: " + getDatetimeFromStringToMillis2("2024-05-14") + ", reverse: " + getMillisToDateTime(getDatetimeFromStringToMillis2("2024-05-14")));
    }
    ...
    public static Long getDatetimeFromStringToMillis2(String sDate) {
        return LocalDateTime.parse(sDate + "T00:00:00").atZone(ZoneId.of("America/Mexico_City")).toInstant().toEpochMilli();
    }
}
